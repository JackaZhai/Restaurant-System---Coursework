...
void displayAllOrders(MYSQL *conn) {
    ...
    cout << "\n==================== 所有订单 ====================\n";
    cout << left << setw(10) << "订单ID" << setw(10) << "桌号" << setw(20) << "菜品名称" << setw(10) << "数量" << setw(10) << "总价" << setw(10) << "状态" << endl;
    cout << "-------------------------------------------------\n";
    while ((row = mysql_fetch_row(res))) {
        ...
        cout << left << setw(10) << (row[0] ? row[0] : "NULL") << setw(10) << (row[1] ? row[1] : "NULL") << setw(20) << (row[2] ? row[2] : "NULL") << setw(10) << (row[3] ? row[3] : "NULL") << setw(10) << (row[4] ? row[4] : "NULL") << setw(10) << status << endl;
    }
    cout << "=============================================\n";
